...
SOURCES += ../src/zxing/*.cpp \
    ...
    ../tests/src/common/reedsolomon/*.cpp \	
	../tests/src/qrcode/*.cpp \
	../tests/src/qrcode/decoder/*.cpp
...
HEADERS += ../src/zxing/*.h \
	...
	../tests/src/common/*.h \
	../tests/src/common/reedsolomon/*.h \
	../tests/src/qrcode/*.h \
	../tests/src/qrcode/decoder/*.h
...
LIBS += "-LF:/ndk-2.0.0-workspace/cppunit/Device-Release" -lcppunit
LIBS += "-LC:/bbndk-2.0.0/target/qnx6/armle-v7/usr/lib" -liconv
